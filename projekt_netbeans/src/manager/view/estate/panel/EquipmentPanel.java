...
public class EquipmentPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Uzywany", "Nowy" }));

        jLabel4.setText("Gwarancja:");

        jLabel5.setText("ms");

        jLabel6.setText("Sklep:");
